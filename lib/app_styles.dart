...
const double kBoerderRaidusList = 11;

final kSourceSansProBold = GoogleFonts.sourceCodePro(
  fontWeight: FontWeight.w700,
);

final kSourceSansProSemiBold = GoogleFonts.sourceCodePro(
  fontWeight: FontWeight.w600,
);

final kSourceSansProMedium = GoogleFonts.sourceCodePro(
  fontWeight: FontWeight.w500,
);

final kSourceSansProRegular = GoogleFonts.sourceCodePro(
  fontWeight: FontWeight.w400,
);

final kSourceSansProLight = GoogleFonts.sourceCodePro(
